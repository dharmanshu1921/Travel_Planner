...
class TravelTasks():
    ...
    def location_task(self, agent, from_city, destination_city, date_from, date_to):
        return Task(
            ...
            Follow this rules : 
            1. if the {destination_city} is in  India : Respond in Hindi.
            """,
            expected_output=f"""
            if the {destination_city} is in a India : Respond in Hindi.
    ...
    def guide_task(self, agent, destination_city, interests, date_from, date_to):    
        return Task(
            description=f"""
            if the {destination_city} is in  India : Respond in Hindi.
    ...
    def planner_task(self, context, agent, destination_city, interests, date_from, date_to):
        return Task(
            ...
            Follow this rules : 
            1. if the {destination_city} is in a India : Respond in Hindi.
            """,
            expected_output="""
            if the {destination_city} is in India : Respond in Hindi.
            ...
            - a breakdown of all hotspots,food and cultural importance.
